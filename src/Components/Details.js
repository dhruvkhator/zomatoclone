...
class Details extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            method: 'GET',
            url: `https://zomato-clone-backend27.herokuapp.com/restaurant/${restaurant}`,
    ...
    handleOrder = (resId) => {
        axios({
            method: 'GET',
            url: `https://zomato-clone-backend27.herokuapp.com/menuitems/${resId}`,
            headers: { 'Content-Type': 'application/json' }
        })
            .then(response => {
    ...
    getData = (data) => {
        return fetch(`https://zomato-clone-backend27.herokuapp.com/payment`, {
            method: "POST",
            headers: {
